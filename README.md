...
[![v3 alpha](https://img.shields.io/badge/v3-3.0.0--alpha.4-orange)](https://github.com/parvenuprompting/safe-mac-cleaner/releases/tag/v3.0.0-alpha.4)
...
De huidige v3-alpha is `3.0.0-alpha.4` en ondersteunt:
...
https://github.com/parvenuprompting/safe-mac-cleaner/releases/tag/v3.0.0-alpha.4
