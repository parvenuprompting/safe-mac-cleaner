...
Grootte-, ouderdom- en limietfilters zijn volledig instelbaar via de GUI en worden onthouden voor de volgende keer. De gebruikersnaam wordt automatisch gedetecteerd.
